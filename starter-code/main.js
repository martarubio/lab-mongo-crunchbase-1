      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "4":
            ...
            db.collection('companies').find({ "funding_rounds.funded_year": 2004, "funding_rounds.funded_month": 2 }, { name: 1, _id: 0 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "5":
            ...
            db.collection('companies').find({ "funding_rounds.funded_year": 2004, "funding_rounds.funded_month": { $gt: 4, $lt: 6 } }, { name: 1, _id: 0 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
